...
import hello.fs.constants.TudouVideoMap;
import hello.fs.model.Album;
...
public class VideoService {
    ...
    public String getRankResults(String keyword, int limit) {
        return reorderService.rankResults(keyword, limit);
    }

    public String getLocalResults(String keyword, int limit) {
        return reorderService.localResults(keyword, limit);
    }
