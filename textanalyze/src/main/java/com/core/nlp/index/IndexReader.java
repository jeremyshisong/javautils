...
public abstract class IndexReader implements Closeable {
  ...
  public static interface ReaderClosedListener {
    ...
    public void onClose(org.apache.lucene.index.IndexReader reader) throws IOException;
  }

  private final Set<ReaderClosedListener> readerClosedListeners = 
      Collections.synchronizedSet(new LinkedHashSet<ReaderClosedListener>());

  private final Set<org.apache.lucene.index.IndexReader> parentReaders =
      Collections.synchronizedSet(Collections.newSetFromMap(new WeakHashMap<org.apache.lucene.index.IndexReader,Boolean>()));
   ...
   * @lucene.experimental */
  public final void registerParentReader(org.apache.lucene.index.IndexReader reader) {
    ensureOpen();
  ...
  private void reportCloseToParentReaders() {
    synchronized(parentReaders) {
      for(org.apache.lucene.index.IndexReader parent : parentReaders) {
      }
    }
  }
